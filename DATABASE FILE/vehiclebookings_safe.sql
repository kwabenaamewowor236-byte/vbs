...
INSERT IGNORE INTO `tms_admin` (`a_id`, `a_name`, `a_email`, `a_pwd`) VALUES
...
INSERT IGNORE INTO `tms_feedback` (`f_id`, `f_uname`, `f_content`, `f_status`) VALUES
...
INSERT IGNORE INTO `tms_pwd_resets` (`r_id`, `r_email`) VALUES
(2, 'admin@mail.com');
...
INSERT IGNORE INTO `tms_user` (`u_id`, `u_fname`, `u_lname`, `u_phone`, `u_addr`, `u_category`, `u_email`, `u_pwd`, `u_car_type`, `u_car_regno`, `u_car_bookdate`, `u_car_book_status`) VALUES
...
INSERT IGNORE INTO `tms_vehicle` (`v_id`, `v_name`, `v_reg_no`, `v_pass_no`, `v_driver`, `v_category`, `v_dpic`, `v_status`) VALUES
